 ...
 *
 * NO PARTNER IDENTITY, and none is reachable: only an UNDECIDED match expires,
 * and the two sides of one were never revealed to each other. Do not add a
 * domain here to make the mail warmer — it would be a masking breach on every
 * path, not just some.
 */
...
export function MatchExpiredEmail({ category }: MatchExpiredProps) {
    ...
    return (
        <EmailLayout preview="A match expired, and you are back in the pool">
            ...
            <Text style={styles.paragraph}>A {category} match sat unanswered long enough to lapse.</Text>
